export class Monster {
  constructor(path, monsterImages, level, monsterData) {
    ...
    this.init(level, monsterData);
  }

  init(level, monsterData) {
    this.maxHp = monsterData.hp + monsterData.increment_hp * level; // 몬스터의 현재 HP
    this.hp = this.maxHp; // 몬스터의 현재 HP
    this.attackPower = monsterData.attack; // 몬스터의 공격력 (기지에 가해지는 데미지)
  }
